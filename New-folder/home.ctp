...
<div class="videoplaypopup">&nbsp;<a href="javascript:void(0)" id="stop-video"><img class="closimgbt" src="http://dbc.meticulosity.com/webroot/img/close.png" onclick="videoplaypopupclose();"></a>
			<?php 
					...
					<video id="Video"  width="590" height="290" controls><source src="<?php echo $video; ?>" type="video/mp4"></video>
			...
			?>
		<div class="popup-more-videos" style="width:500">
				<ul class ="list-video">
				<li><a href="<?php echo $video; ?>?rel=0&showinfo=0&autoplay=1">
				<img class ="Video-more" src="http://dbc.meticulosity.com/webroot/img/days.jpg" alt="">
				</a>
				<!--span class="video-episode">Episode 1</span-->
				</li>
				
				<li style="margin-right:0;"><a href="<?php echo $video; ?>?rel=0&showinfo=0&autoplay=1">
				<img class ="Video-more" src="http://dbc.meticulosity.com/webroot/img/days.jpg" alt="">
				</a>
				<!--span class="video-episode">Episode 2</span-->
				</li>
				
				<li><a href="<?php echo $video; ?>?rel=0&showinfo=0&autoplay=1">
				<img class ="Video-more" src="http://dbc.meticulosity.com/webroot/img/days.jpg" alt="">
				</a>
				<!--span class="video-episode">Episode 3</span-->
				</li>
				
				<li style="margin-right:0;"><a href="<?php echo $video; ?>?rel=0&showinfo=0&autoplay=1">
				<img class ="Video-more" src="http://dbc.meticulosity.com/webroot/img/days.jpg" alt="">
				</a>
				<!--span class="video-episode">Episode 4</span-->
				</li>
				</ul>
			</div>
